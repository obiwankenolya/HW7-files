        ...
        for dish in dishes:
            if dish in cook_book.keys():
                for ingredient in cook_book[dish]:
                    if ingredient['ingridient_name'] in ing_dict.keys():
                        ing_dict[ingredient]['ingridient_name']['quantity'] += ingredient['quantity'] * person_count
                    else:
                        ing_dict[ingredient]['ingridient_name'] = {
